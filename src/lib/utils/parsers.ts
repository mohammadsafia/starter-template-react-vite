...
import { z } from 'zod';
import { ExtendedColumnFilter, ExtendedColumnSort } from '@app-types';
...
export const getSortingStateParser = <TData extends Record<string, unknown>>(columnIds?: string[] | Set<string>) => {
...
const filterItemSchema = z.object({
  ...
  variant: z.enum(DATA_TABLE_CONFIG.filterVariants),
  operator: z.enum(DATA_TABLE_CONFIG.operators),
  filterId: z.string(),
});
