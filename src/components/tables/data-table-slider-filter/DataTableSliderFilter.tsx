...
import { Button, Divider, Popover, Label, Input } from '@components/ui';
...
export default function DataTableSliderFilter<TData>({ column, title }: DataTableSliderFilterProps<TData>) {
